...
5. [MSc] Megerteni a FLUSS szemantikai szegmentaciios algoritmust.
...
> **[MSc]** SCRIMP++ inkrementalis frissitessel mukodik, igy valodes ido-adatsorokra is alkalmazhato. <sup>[[3]](#ref-3)</sup>
...
**Motivum-kereses**: ismetlodo mintak azonositasa (pl. EKG-ciklus). **Diszkord-detekciio**: anomaliia-keresees. **[MSc] FLUSS**: rezsimvaltas-pontok azonositasa az MP Index ivein. <sup>[[1]](#ref-1)</sup>
