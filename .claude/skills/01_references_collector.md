...
- 💬 NOTE: **Weblapok mentési módjai -- képvesztés pipeline-következménnyel.** Ajánlott sorrend: (1) **SingleFile Chrome bővítmény** (képek base64-be ágyazva); (2) **PDF-print** (`msedge --headless --print-to-pdf`, MinerU feldolgozható); (3) egyszerű HTML-mentés (csak szöveg, képek nélkül, leggyengébb). Egyszerű HTML esetén a `figure_catalog.json` üres marad, Qfig entry-k kihagyódnak.
