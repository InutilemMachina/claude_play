...
- 🔲 TODO: **Skálázhatósági probléma DFS pipeline-nál (tesztelve 2026-05-27).** A 06_excerpt_block_maker 🤖 Claude-feladatként van definiálva, de 40 DFS query esetén 228 blockquote szükséges (41 `##` fejezet + 187 `###` alszakasz, 190KB fájl). Ez kézzel/Claude-dal nem elvégezhető -- automatizálás szükséges. Megoldás: Python script (`06_excerpt_block_maker.py`), amely NLM-lekérdezéssel vagy szabály-alapon (első/utolsó mondat kiemelése) generálja a blockquote-okat. Az eredeti 4 queryre tervezett skill DFS-re nem alkalmazható.
